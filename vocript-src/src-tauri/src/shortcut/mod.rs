...
#[tauri::command]
#[specta::specta]
pub fn update_custom_profile_commands(
    app: AppHandle,
    commands: Vec<settings::WordReplacement>,
) -> Result<(), String> {
    let mut settings = settings::get_settings(&app);
    settings.custom_profile_commands = commands;
    settings::write_settings(&app, settings);
    Ok(())
}
...
#[tauri::command]
#[specta::specta]
pub fn change_live_auto_paste_setting(app: AppHandle, enabled: bool) -> Result<(), String> {
    let mut settings = settings::get_settings(&app);
    settings.live_auto_paste = enabled;
    settings::write_settings(&app, settings);
    Ok(())
}
...
#[tauri::command]
#[specta::specta]
pub fn change_theme_setting(app: AppHandle, theme: settings::AppTheme) -> Result<(), String> {
    let mut settings = settings::get_settings(&app);
...
#[tauri::command]
#[specta::specta]
pub fn change_accent_tint_surfaces_setting(app: AppHandle, enabled: bool) -> Result<(), String> {
    let mut settings = settings::get_settings(&app);
    settings.accent_tint_surfaces = enabled;
    settings::write_settings(&app, settings);
    Ok(())
}
