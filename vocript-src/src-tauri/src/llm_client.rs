...
fn build_headers(provider: &PostProcessProvider, api_key: &str) -> Result<HeaderMap, String> {
    ...
    headers.insert(
        REFERER,
        HeaderValue::from_static("https://github.com/Mun1to/VoCript"),
    );
    headers.insert(
        USER_AGENT,
        HeaderValue::from_static("VoCript/1.0 (+https://github.com/Mun1to/Vocript)"),
    );
    headers.insert("X-Title", HeaderValue::from_static("VoCript"));
